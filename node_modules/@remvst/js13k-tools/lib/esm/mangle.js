...
export function mangle(code, opts) {
    const protectedNames = new Set();
    for (const name of PROTECTED_NAMES.keywords)
        protectedNames.add(name);
    for (const name of PROTECTED_NAMES.dom)
        protectedNames.add(name);
    for (const name of opts.skip)
        protectedNames.add(name);
    for (const name of opts.force)
...
export function analyze(code, opts) {
